...
- center the value of the math factor by the first timepoint
- make sure coef & p-vals of the first 2 analyses are the same
...
plot_model(dcoded_tplan_inter, type = "pred", terms = c("training_plan_id", "time[6]")) + 
    theme_minimal() + labs(title = "Predicted Math values after 7 weeks")
